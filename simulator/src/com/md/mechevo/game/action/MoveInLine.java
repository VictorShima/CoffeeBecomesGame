...
public class MoveInLine extends Action {
	...
	public boolean check(State state) {
		...
		return (direction.equals(Direction.FORWARD)) ? state.getMap().canSolidMove(this.getOwner(),
				this.getOwner().getAngle(), true) : state.getMap().canSolidMove(this.getOwner(),
				this.getOwner().getAngle(), false);
	}
