...
/**
 * A Condition evaluates if something can be done.
 * Conditions can be used by AIEntries to know if the actions should be executed, or
 * by Weapons to know if its viable to fire a weapon.
 */
